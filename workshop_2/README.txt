...
2) Power up the Arduino board through the Vin pin (WHEN THE USB CABLE ISN'T PLUGGED). The Vin pin takes an input voltage from 6V to 12V, don't plug it to the 5V output of the L298N.
...
7) When working with the L298N motor driver, make sure the GND of the Arduino is wired to the GND of the L298N.

8) Anytime working with PWM == Analog output, we don't use the pinMode function (analogWrite directly).
